...
class Ccc_VendorInventory_Adminhtml_ConfigurationController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        echo "<pre>";
        // print_r(Mage::getConfig()->getNode('modules'));
        echo "</pre>";
        // Mage::dispatchEvent('vendorinventory_event_observer', ['banner'=>Mage::getModel('banner/banner')]);
        // Mage::dispatchEvent('second_event', ['banner'=>Mage::getModel('banner/banner')]);
        $this->_initAction();
